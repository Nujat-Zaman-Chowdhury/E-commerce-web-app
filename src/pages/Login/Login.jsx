    ...
    return (
      ...
      <div className="w-1/2 flex justify-center items-center">
        <div className="bg-[#FAFAFA] p-6 font-barlow rounded-md">
          ...
          <form noValidate="" action="" className="space-y-12 pt-4">
            <div className="space-y-4">
              ...
              <div className='text-right'>
                <p className='text-[#1E99F5] font-medium'>Forgot Password</p>
              </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-4">
                <div class="btn  bg-none shadow-none flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border border-[#D9D9D9] rounded-md ">
                ...
                <div class="btn  bg-none shadow-none flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border border-[#D9D9D9] rounded-md ">
                  ...
                  <span class="mx-2">Sign in with Apple</span>
                </div>
              </div>
              <p className="px-6 text-sm text-center text-black font-medium my-5">
                Have an account?
                <Link href="/sign-up" className="hover:underline text-[#0F3DDE]">
                  Sign Up
                </Link>
              </p>
            </div>
